...
- **Internación tests (jun 2026):** `internacion/tests/helpers.py` (`unique_suffix`); admisión crea internación activa sobre cama `DISPONIBLE` (modelo la marca `OCUPADA`); infraestructura usa `sector_id` en POST camas y nombres únicos por corrida.
