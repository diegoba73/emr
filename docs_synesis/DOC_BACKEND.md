...
| `laboratorio` | LIMS nativo: órdenes/resultados (Fase A), muestras transaccionales (B1), vínculo `ResultadoExamen.muestra` (B2), obligatoriedad progresiva por `TipoExamen.requiere_muestra` (B2-B) |
