#!/usr/bin/env python3
"""
Script de prueba final para el sistema de consultas médicas
"""
...
def test_consultas_system():
    print_section("PRUEBA FINAL DEL SISTEMA DE CONSULTAS MÉDICAS")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if not turnos_reservados:
                ...
                print("   💡 Crea un turno desde la interfaz de secretaria primero")
                return
    ...
    print("2. Inicia sesión con dr.garcia / medico123")
    print("3. Ve a 'Mis Turnos'")
    print("4. Confirma un turno y crea una consulta")
